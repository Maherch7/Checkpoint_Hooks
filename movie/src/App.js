...
function App() {
  ...
  return (
    <div>
      <NavMovie/>
      <FilterMovie setSearch={setSearch} setStars={setStars} search={search} stars={stars}/>
      <AddMovie setMovies={setMovies} movies={movies}/>
      <ListMovie movies={movies} search={search} stars={stars}/>
